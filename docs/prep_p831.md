[Home](../README.md) > [Preparation](preparation.md) > Preparation for the P.831
# Preparation of P.831 test

The following steps should be performed to prepare the P.831 test setup.
...
1. Create your custom project by running the master script: 
    ...
    * `YOUR_PROJECT_NAME_p831.html`: Customized HIT app to be used in Amazon Mechanical Turk (AMT).
    * `YOUR_PROJECT_NAME_publish_batch.csv`: List of dynamic content to be used during publishing batch in AMT.
    * `YOUR_PROJECT_NAME_p831_result_parser.cfg`: Customized configuration file to be used by `result_parser.py` script
